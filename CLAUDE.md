...
4. `src/counterexample.py` — on verify failure, runs **two independent searches**: LLM-based (Claude) and symbolic (SymPy/CAS). Both signals are preserved and returned; neither replaces the other.
